...
class SearchResultsRecyclerViewAdapter(private val context: Context, private val filteredUsers: ArrayList<FilteredUserData>, private val groupId: Int, private val searchView: SearchView, private val model: GroupViewModel): RecyclerView.Adapter<SearchResultViewHolder>()  {
