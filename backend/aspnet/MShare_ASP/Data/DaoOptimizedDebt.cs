...
namespace MShare_ASP.Data {
    ...
    public class DaoOptimizedDebt {
        ...
        /// <summary>
        /// Foreign key to the owing user
        /// </summary>
        [Column("user_owes_id")]
        public long UserOwesId { get; set; } = 0;
        /// <summary>
        /// Foreign key to the owed user
        /// </summary>
        [Column("user_owed_id")]
        ...
        public long OweAmount { get; set; }
         ...
         /// <summary>
        /// The group inwhich the the users owe one another.
        /// </summary>
        [JsonIgnore]
        [ForeignKey("GroupId")]
        ...
        /// <summary>
        /// The user that owes the other one.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// The user that is owed by the other one.
        /// </summary>
        [JsonIgnore]
