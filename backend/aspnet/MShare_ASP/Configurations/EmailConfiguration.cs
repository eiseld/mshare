namespace MShare_ASP.Configurations
{
    ...
    public interface IEmailConfiguration
    {
        ...
        /// <summary>Email Address of the account (e.g. noreply.mshare@gmail.com)</summary>
        string Address { get; }

        /// <summary>Password for the email address</summary>
        string Password { get; }

        /// <summary>Address of the SMTP server</summary>
        string SmtpAddress { get; }

        /// <summary>Port used with SMTP server</summary>
        int SmtpPort { get; }
    }
