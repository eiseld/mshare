...
namespace MShare_ASP.Services
{
    internal class GroupService : IGroupService
    {
        ...
        public GroupService(MshareDbContext context, IEmailService emailService, IOptimizedService optimizedService, IURIConfiguration uriConf, IStringLocalizer<LocalizationResource> localizer, IRazorViewToStringRenderer renderer)
        {
            Context = context;
